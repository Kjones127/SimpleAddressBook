							...
							<div class="list-group names">
							 <?php
							  ...
							  <li class="list-group-item name">
							  		...
							  		<span class="badge badge-delete"  id="getUserDelete" data-toggle="modal" data-id="<?php echo $row['ID']; ?>" data-target="#deleteContact"><i class="fa fa-times"></i></span>

							  		<span class="badge badge-edit"  id="getUserEdit" data-id="<?php echo $row['ID'];?>" data-toggle="modal" data-target="#EditContact"><i class="fa fa-pencil-square-o"></i></span>

							  		<span class="badge badge-info"  id="getUser" data-toggle="modal" data-id="<?php echo $row['ID']; ?>" data-target="#profile"><i class="fa fa-info"></i></span>

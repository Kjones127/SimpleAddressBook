...
if(isset($_POST['Submit'])) {    
    ...
    if(empty($fname) || empty($lname) ) {
        ...
        if( in_array($imageFileType, $extensions_arr) ){
             ...
             // // //insert data to database        
    $sql = "UPDATE user_info SET Firstname = :first_name, Lastname = :last_name, Jobtitle = :job_title, Phone = :phone_number, Email = :email, website = :website, photo = :user_image WHERE ID = :id";
                            ...
                            <div class="row">
                              <div class="col-sm-6 offset-md-3">
                                  <div class="card card-success-custom">
                                    ...
                                    <p>You have successfully updated this contact with photo.</p>
        ...
        else
        {
                 ...
                 $sql = "UPDATE user_info SET Firstname = :first_name, Lastname = :last_name, Jobtitle = :job_title, Phone = :phone_number, Email= :email, website = :website WHERE ID = :id ";
                        ...
                        <div class="row">
                          <div class="col-sm-6 offset-md-3">
                              <div class="card card-success-custom">
                                <h1>Success!</h1>
                                <p class="alerticon"><i class="fa fa-check"></i></p>
                                <p>You have successfully updated this contact.</p>
                                <a href="index.php">Go Back</a>
                             </div>
                        </div>
                     </div>
